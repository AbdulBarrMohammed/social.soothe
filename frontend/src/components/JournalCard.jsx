    ...
    return (
        <>
                ...
                {journal.mood == 'stressed' &&
                    <Link to={`/selectedJournal/${journal._id}`} className="flex flex-col rounded-3xl cursor-pointer bg-emojiStressed p-5 hover:opacity-85 transition duration-300 ease-in-out">
                        <div className="flex flex-col items-center justify-center p-2 gap-5">
